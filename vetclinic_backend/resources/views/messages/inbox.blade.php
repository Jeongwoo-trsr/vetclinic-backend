    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="bg-[#1e3a5f] px-4 sm:px-6 py-4 sm:py-5">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                <div>
                    ...
                    <p class="text-gray-200 text-xs sm:text-sm mt-1">You have {{ $unreadCount }} unread message(s)</p>
                </div>
        ...
        <div class="border-b border-gray-200 bg-gray-50">
            <div class="flex px-3 sm:px-6 overflow-x-auto">
                <a href="{{ route('messages.inbox') }}" class="px-3 sm:px-4 py-3 text-xs sm:text-sm font-medium text-[#0066cc] border-b-2 border-[#0066cc] whitespace-nowrap flex items-center">
                ...
                <table class="w-full">
                    <thead class="bg-[#1e3a5f] border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-4 lg:px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">From</th>
                        ...
                        @forelse($messages as $message)
                            <tr class="hover:bg-gray-50 cursor-pointer transition {{ !$message->is_read ? 'bg-blue-50' : '' }}" 
                                ...
                                <td class="px-4 lg:px-6 py-4">
                                    <div class="text-sm {{ !$message->is_read ? 'font-semibold text-[#0066cc]' : 'text-gray-900' }}">
                                        {{ $message->subject }}
                                    </div>
                            ...
                            <div class="flex-1 min-w-0" onclick="window.location='{{ route('messages.show', $message) }}'">
                                ...
                                <div class="flex items-start justify-between gap-2 mb-2">
                                    <div class="flex items-center gap-2 min-w-0 flex-1">
                                        <div class="w-10 h-10 rounded-full bg-[#0066cc] flex items-center justify-center text-white font-semibold text-sm flex-shrink-0">
                                            {{ strtoupper(substr($message->sender->name, 0, 1)) }}
                                        </div>
                                ...
                                <!-- Subject -->
                                <h3 class="text-sm {{ !$message->is_read ? 'font-semibold text-[#0066cc]' : 'font-medium text-gray-900' }} mb-1 line-clamp-1">
                                    {{ $message->subject }}
                                </h3>
